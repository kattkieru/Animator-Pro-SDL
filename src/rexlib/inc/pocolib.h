...
typedef struct polib_screen {
	...
	char	 *protostr10;
	void	 (*plIconBlit)(void* source, int snext, int sx, int sy, int width, int height, void* dest, int dx, int dy, int color);
	char	 *protostr11;
	void	 (*plBlit)(void* source, int sx, int sy, int width, int height, void* dest, int dx, int dy);
	char	 *protostr12;
	void	 (*plKeyBlit)(void* source, int sx, int sy, int width, int height, void* dest, int dx, int dy, int key_color);
	char	 *protostr13;
...
typedef struct polib_user {
	...
	char	 *protostr5;
	Boolean  (*plQquestion)(char* question, ...);
	char	 *protostr6;
	Boolean  (*plQnumber)(int* num, int min, int max, char* header);
	char	 *protostr7;
	Boolean  (*plQstring)(char* string, int size, char* header);
	char	 *protostr8;
	Boolean  (*plQfile)(char* suffix, char* button, char* inpath, char* outpath, Boolean force_suffix, char* header);
	char	 *protostr9;
	Boolean  (*plQlist)(char* choicestr, int* choice, Popot* items, int icount, int* ipos, char* header);
	char	 *protostr10;
	int 	 (*plQcolor)(void);
	char	 *protostr11;
	Errcode  (*plQerror)(Errcode err, char* format, ...);
	char	 *protostr12;
	Boolean  (*plRubBox)(int* x, int* y, int* w, int* h);
	char	 *protostr13;
	Boolean  (*plRubCircle)(int* x, int* y, int* rad);
	char	 *protostr14;
	Boolean  (*plRubLine)(int x1, int y1, int* x2, int* y2);
	char	 *protostr15;
	int 	 (*plRubPoly)(Popot* x, Popot* y);
	char	 *protostr16;
	Boolean  (*plDragBox)(int* x, int* y, int* w, int* h);
	char	 *protostr16a;
	void	 (*plWaitClick)(int* x, int* y, int* left, int* right, int* key);
	char	 *protostr17;
	void	 (*plPollInput)(int* x, int* y, int* left, int* right, int* key);
	char	 *protostr18;
	void	 (*plWaitInput)(int* x, int* y, int* left, int* right, int* key);
	char	 *protostr19;
	...
	char	 *protostr25;
	Boolean  (*plUdQnumber)(int* inum, int min, int max, void* update, void* data, char* fmt, ...);
	char	 *protostr26;
	...
	char	 *protostr29;
	void	 (*plPhysicalPollInput)(int* x, int* y, int* left, int* right, int* key);
	char	 *protostr30;
	void	 (*plPhysicalWaitInput)(int* x, int* y, int* left, int* right, int* key);
	char	 *protostr31;
	Boolean  (*plPhysicalRubMoveBox)(int* x, int* y, int* width, int* height, Boolean clip_to_screen);
	char	 *protostr32;
